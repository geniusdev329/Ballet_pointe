                ...
                <div class="des_pc">
                    <div class="part1">
                        <div class="user_avatar">
                            <div class="avatar-upload">
                                ...
                                @enderror
                                <img src="./images/users/avatar-1.jpg" alt="Default Avatar" class="avatar_img" id="avatarImage">
                                <div>
                    ...
                    <div class="part1">
                        <div class="part1_main">
                            ...
                            <div class="form-group">
                                <div class="part1_all_radio">
                                    <input type="text" class="form-control_1" name="ballet_career"
                                        value="{{ old('ballet_career') }}">
                                    ...
                                    <div class="sp_radio">
                                        <div class="des">
                                            <input type="radio" class="des_radio" name="ballet_level" value="入門～初級者"
                                                {{ old('ballet_level') == '入門～初級者' ? 'checked' : '' }}>
                                    ...
                                    <div class="sp_radio">
                                        <div class="des">
                                            <input type="radio" class="des_radio" name="ballet_level" value="初級～中級者"
                                                {{ old('ballet_level') == '初級～中級者' ? 'checked' : '' }}>
                                    ...
                                    <div class="sp_radio">
                                        <div class="des">
                                            <input type="radio" class="des_radio" name="ballet_level" value="中級～上級者"
                                                {{ old('ballet_level') == '中級～上級者' ? 'checked' : '' }}>
                                    ...
                                    <div class="sp_radio">
                                        <div class="des">
                                            <input type="radio" class="des_radio" name="ballet_level"
                                                value="上級～プロフェッショナル"
                                                {{ old('ballet_level') == '上級～プロフェッショナル' ? 'checked' : '' }}>
                        ...
                        <div class="part1_main">
                            ...
                            <div class="form-group">
                                <div class="part1_all_radio margin-top">
                                    <div class="sp_radio">
                                        <div class="des">
                                            <input type="radio" class="des_radio" name="mail_magazin" value="受け取る"
                                                {{ old('mail_magazin') == '受け取る' ? 'checked' : '' }}>
                                            <p class="des_tlt">受け取る</p>
                                        </div>
                                    </div>
                                    <div class="sp_radio">
                                        <div class="des">
                                            <input type="radio" class="des_radio" name="mail_magazin" value="受け取らない"
                                                {{ old('mail_magazin') == '受け取らない' ? 'checked' : '' }}>
                                ...
                                <div class="des_radio">
                                    <label class="des des_tlt">
                                        <input type="checkbox" class="des_checkbox" name="privacy_policy_confirm"
                                            {{ old('privacy_policy_confirm') ? 'checked' : '' }}>
                                        プライバシーポリシーを確認
                                    </label>
                                </div>
...
<script lang="javascript">
    $('#avatarInput').change(function(event){
        if(event && event.target && event.target.files.length > 0){
            ...
            $('#avatarImage').attr('src', './images/users/avatar-1.jpg');
        }
    })
</script>
@endsection